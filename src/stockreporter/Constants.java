...
/**
 * This will keep the initial stocks for scraping The program will insert these
 * stocks if the table is empty
 */
public class Constants {
    ...
    public static final String[] stockSourceNames = {"Yahoo", "Investopedia", "MarketWatch", "Fidelity"};
    ...
    public static final String SCRAP_DATA_FROM_MARKETWATCH = stockSourceNames[2];
    public static final String SCRAP_DATA_FROM_FIDELITY = stockSourceNames[3];
}
