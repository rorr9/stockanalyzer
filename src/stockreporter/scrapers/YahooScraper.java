 ...
 * Finance
 *
 * Yahoo Finance creates a page for each ticker symbol with the url
 * "http://finance.yahoo.com/quote/[symbol]" Each page is populated with a large
 * table that carries each data point in a different <td> tag
 *
 * This class iterates through all <td> tags, compares their attributes to the
...
public class YahooScraper implements Scraper {
    ...
    /**
     * Scrape summary data for each StockTicker in the superclass's
     * List<StockTicker>
     */
    @Override
    ...
    /**
     * <<<<<<< HEAD:src/stockreporter/scrapers/YahooScraper.java Scrap summary
